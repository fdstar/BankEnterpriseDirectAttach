...
{
    /// <summary>
    /// 3.9.3.16电子商业汇票质押托管转换登记簿响应主体
    /// </summary>
    public class V1_EBPCONVERTREGISTERTRNRS : IResponse
    {
        /// <summary>
        /// 3.9.3.16电子商业汇票质押托管转换登记簿响应主体
        /// </summary>
        public EBPCONVERTREGISTERTRNRS EBPCONVERTREGISTERTRNRS { get; set; }
    }
    /// <summary>
    /// 3.9.3.16电子商业汇票质押托管转换登记簿响应主体
    /// </summary>
    public class EBPCONVERTREGISTERTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.9.3.16电子商业汇票质押托管转换登记簿响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public EBPCONVERTREGISTERTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.9.3.16电子商业汇票质押托管转换登记簿响应内容
    /// </summary>
    public class EBPCONVERTREGISTERTRN_RSBODY
    {
        /// <summary>
        /// MORE是否有下一页，Y有，N无
        /// </summary>
        ...
        /// <summary>
        /// 3.9.3.16电子商业汇票质押托管转换登记簿响应集合
        /// </summary>
        [XmlElement("CONTENT", Order = 10)]
        public List<EBPCONVERTREGISTERTRN_CONTENT> List { get; set; }
    }
    /// <summary>
    /// 3.9.3.16电子商业汇票质押托管转换登记簿响应内容
    /// </summary>
    public class EBPCONVERTREGISTERTRN_CONTENT
    {
        /// <summary>
        /// 业务类型，01-质押转托管 02-托管转质押	必回
        /// </summary>
        [XmlElement(Order = 1)]
