...
{
    /// <summary>
    /// 3.9.3.20电子商业汇票在池票据登记簿响应主体
    /// </summary>
    public class V1_EBPINPOOLBILLREGISTERTRNRS : IResponse
    {
        /// <summary>
        /// 3.9.3.20电子商业汇票在池票据登记簿响应主体
        /// </summary>
        public EBPINPOOLBILLREGISTERTRNRS EBPINPOOLBILLREGISTERTRNRS { get; set; }
    }
    /// <summary>
    /// 3.9.3.20电子商业汇票在池票据登记簿响应主体
    /// </summary>
    public class EBPINPOOLBILLREGISTERTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.9.3.20电子商业汇票在池票据登记簿响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public EBPINPOOLBILLREGISTERTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.9.3.20电子商业汇票在池票据登记簿响应内容
    /// </summary>
    public class EBPINPOOLBILLREGISTERTRN_RSBODY
    {
        /// <summary>
        /// MORE是否有下一页，Y有，N无
        /// </summary>
        ...
        /// <summary>
        /// 3.9.3.20电子商业汇票在池票据登记簿响应集合
        /// </summary>
        [XmlElement("CONTENT", Order = 10)]
        public List<EBPINPOOLBILLREGISTERTRN_CONTENT> List { get; set; }
    }
    /// <summary>
    /// 3.9.3.20电子商业汇票在池票据登记簿响应内容
    /// </summary>
    public class EBPINPOOLBILLREGISTERTRN_CONTENT
    {
        /// <summary>
        /// 客户名称	必回
        /// </summary>
