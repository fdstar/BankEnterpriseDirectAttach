...
{
    /// <summary>
    /// 3.20.3进口信用证付款承兑拒付申请响应主体
    /// </summary>
    public class V1_LCPAYAPPLYTRNRS : IResponse
    {
        /// <summary>
        /// 3.20.3进口信用证付款承兑拒付申请响应主体
        /// </summary>
        public LCPAYAPPLYTRNRS LCPAYAPPLYTRNRS { get; set; }
    }
    /// <summary>
    /// 3.20.3进口信用证付款承兑拒付申请响应主体
    /// </summary>
    public class LCPAYAPPLYTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.20.3进口信用证付款承兑拒付申请响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public LCPAYAPPLYTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.20.3进口信用证付款承兑拒付申请响应内容
    /// </summary>
    public class LCPAYAPPLYTRN_RSBODY
    {
        /// <summary>
        /// 系统关联业务编号	必回
        /// </summary>
