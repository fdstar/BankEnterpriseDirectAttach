...
{
    /// <summary>
    /// 3.20.4进口信用证开立通知查询响应主体
    /// </summary>
    public class V1_LCOPENNOTICEQUERYTRNRS : IResponse
    {
        /// <summary>
        /// 3.20.4进口信用证开立通知查询响应主体
        /// </summary>
        public LCOPENNOTICEQUERYTRNRS LCOPENNOTICEQUERYTRNRS { get; set; }
    }
    /// <summary>
    /// 3.20.4进口信用证开立通知查询响应主体
    /// </summary>
    public class LCOPENNOTICEQUERYTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.20.4进口信用证开立通知查询响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public LCOPENNOTICEQUERYTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.20.4进口信用证开立通知查询响应内容
    /// </summary>
    public class LCOPENNOTICEQUERYTRN_RSBODY
    {
        /// <summary>
        /// 是否有下一页，Y有，N无
        /// </summary>
        ...
        /// <summary>
        /// 3.20.4进口信用证开立通知查询响应集合
        /// </summary>
        [XmlElement("CONTENT", Order = 1)]
        public List<LCOPENNOTICEQUERYTRN_CONTENT> List { get; set; }
    }
    /// <summary>
    /// 3.20.4进口信用证开立通知查询响应明细
    /// </summary>
    public class LCOPENNOTICEQUERYTRN_CONTENT
    {
        /// <summary>
        ...
        /// <summary>
        /// preadvice date ,日期yyyy-MM-dd
        /// </summary>
        [XmlIgnore]
        public DateTime? PREADVICEDATE { get; set; }
        /// <summary>
        /// preadvice date  YYYY-MM-DD, 对应<see cref="PREADVICEDATE"/>
        /// </summary>
        [XmlElement("PREADVICEDATE", Order = 2)]
        ...
        /// <summary>
        /// Applicant 长度：5*35	必回
        /// </summary>
        [XmlElement(Order = 3)]
        public string APPLICANT { get; set; }
        /// <summary>
        /// Beneficiary 长度：5*35	必回
        /// </summary>
        [XmlElement(Order = 4)]
        ...
        /// </summary>
        [XmlElement("LCISSUEDDATE", Order = 5)]
        ...
        /// </summary>
        [XmlElement("LCEXPIRYDATE", Order = 6)]
        ...
        /// </summary>
        [XmlElement("LASTESTSHIPMENTDATE", Order = 22)]
