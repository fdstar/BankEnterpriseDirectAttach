...
namespace BEDA.CIB.Contracts.Responses
{
    ...
    /// 批量托收或子账户托收明细查询响应主体
    /// </summary>
    public class SECURITIES_MSGSRSV1_FBBATCHSTMTTRNRS : IResponse
    {
        /// <summary>
        /// 批量托收或子账户托收明细查询响应
        /// </summary>
    ...
    /// 付款信息
    /// </summary>
    public class FBBATCHSTMTTRN_PAYINFO : Requests.PAYINFO
    {
        /// <summary>
        /// 业务种类代码，最大20位	必输
        /// 同必输的还有<see cref="Requests.PAYINFO.BIZCODE1"/>
        /// 另外BIZCODE2此处不存在，所以切记勿要输入<see cref="Requests.PAYINFO.BIZCODE2"/>
        /// </summary>
        [XmlElement(Order = 6)]
