...
namespace BEDA.CIB.Contracts.Requests
{
    ...
    /// 3.18.8跨境电商付汇请求主体
    /// </summary>
    public class V1_CBECTRANSFERTRNRQ : IRequest<V1_CBECTRANSFERTRNRS>
    {
        /// <summary>
        /// 3.18.8跨境电商付汇请求主体
        /// </summary>
        public CBECTRANSFERTRNRQ CBECTRANSFERTRNRQ { get; set; }
    }
    /// <summary>
    /// 3.18.8跨境电商付汇请求主体
    /// </summary>
    public class CBECTRANSFERTRNRQ : BIZRQBASE
    {
        /// <summary>
        /// 3.18.8跨境电商付汇请求内容
        /// </summary>
        [XmlElement(Order = 2)]
        public CBECTRANSFERTRN_RQBODY RQBODY { get; set; }
    }
    /// <summary>
    /// 3.18.8跨境电商付汇请求内容
    /// </summary>
    public class CBECTRANSFERTRN_RQBODY
    {
        /// <summary>
        /// 发电级别 空:默认为普通 1-紧急 非必输
        /// </summary>
        [XmlElement(Order = 0)]
        ...
        /// <summary>
        /// 业务类型(字母必须大写) 集中付汇:JZF 轧差付汇:GCF 必输
        /// </summary>
        [XmlElement(Order = 2)]
        public string BUSN_TYPE { get; set; }
        /// <summary>
        /// 汇款类型 0-行内 1-境内 2-境外 非必输
        /// </summary>
        [XmlElement(Order = 3)]
        ...
        /// <summary>
        /// 收款人名称及地址（仅限英文输入）(长度140位) 数字 /-？：（）.,'+ a-z A-Z 以及空格	必输
        /// </summary>
        [XmlElement(Order = 13)]
        public string PAYEE_NAME { get; set; }
        /// <summary>
        /// 收款人常驻国家（仅限英文输入） 数字 /-？：（）.,'+ a-z A-Z 以及空格 参考附录 结售汇国家地区代码 中的国标 必输
        /// </summary>
        [XmlElement(Order = 14)]
        ...
        /// <summary>
        /// 收款人开户银行SWIFT CODE（仅限英文输入）数字 /-？：（）.,'+ a-z A-Z 以及空格	必输
        /// </summary>
        [XmlElement(Order = 16)]
        public string PAYEE_BANK_CODE { get; set; }
        /// <summary>
        /// 收款人开户银行名称及地址（仅限英文输入）(长度140位)数字 /-？：（）.,'+ a-z A-Z 以及空格	必输
        /// </summary>
        [XmlElement(Order = 17)]
        public string PAYEE_BANK_NAME { get; set; }
        /// <summary>
        /// 收款行代理行代码WIFT CODE	非必输
        /// </summary>
        [XmlElement(Order = 18)]
        public string AGENT_BANK_CODE { get; set; }
        /// <summary>
        /// 收款行代理行名称（仅限英文输入）数字 /-？：（）.,'+ a-z A-Z 以及空格(长度140位)	非必输
        /// </summary>
        [XmlElement(Order = 19)]
        public string AGENT_BANK_NAME { get; set; }
        /// <summary>
        /// 发报行致收报行信息（仅限英文输入）数字 /-？：（）.,'+ a-z A-Z 以及空格(长度140位)	非必输
        /// </summary>
        [XmlElement(Order = 20)]
        ...
        /// <summary>
        /// 费用币别（扣费账号不为空时必输，且必须和扣费账号的币种保持一致）	非必输
        /// </summary>
        [XmlElement(Order = 22)]
        public string BEAR_CURRENCY { get; set; }
        /// <summary>
        /// 扣费账号（当费用承担方不为BEN时,扣费账号必输）必须是兴业上网登记自有账号	非必输
        /// </summary>
        [XmlElement(Order = 23)]
        public string CHANGE_FEE_ACCTNO { get; set; }
        /// <summary>
        /// 汇款附言（仅限英文输入）数字 /-？：（）.,'+ a-z A-Z 以及空格(长度210位)	非必输
        /// </summary>
        [XmlElement(Order = 24)]
        public string REMIT_MEMO { get; set; }
        /// <summary>
        /// 汇款人类型(默认居民机构) (字母必须大写) 非必输
        /// CNI：境内非居民个人
        /// CNO：境内非居民机构
        /// DEI：居民个人
        /// DEO：居民机构
        ...
        /// <summary>
        /// 贸易类型默认 非货物贸易核查项下 出现）(字母必须大写) 非必输
        /// M：货物贸易核查项下
        /// N：非货物贸易核查项下
        /// </summary>
        [XmlElement(Order = 27)]
        ...
        /// <summary>
        /// 基础信息确认标识(字母必须大写) 空：否 X：是 非必输
        /// </summary>
        [XmlElement(Order = 29)]
        public string BASE_INFO_FLAG { get; set; }
        /// <summary>
        /// 结算方式，默认电汇(字母必须大写) 非必输
        /// L－信用证
        /// G－保函
        /// C－托收
        /// T－电汇
        ...
        /// <summary>
        /// 合同号 如果贸易类型是 货物贸易项下，则为必输项，否则可不输。	非必输
        /// </summary>
        [XmlElement(Order = 40)]
        public string CONTRACT_NO { get; set; }
        /// <summary>
        /// 发票号 如果贸易类型是 货物贸易项下，则为必输项，否则可不输。	非必输
        /// </summary>
        [XmlElement(Order = 41)]
