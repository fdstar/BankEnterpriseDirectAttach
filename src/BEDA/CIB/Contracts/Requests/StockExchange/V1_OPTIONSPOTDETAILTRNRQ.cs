...
{
    /// <summary>
    /// 3.5.12期权现货交易明细查询请求主体
    /// </summary>
    public class V1_OPTIONSPOTDETAILTRNRQ : IRequest<V1_OPTIONSPOTDETAILTRNRS>
    {
        /// <summary>
        /// 3.5.12期权现货交易明细查询请求主体
        /// </summary>
        public OPTIONSPOTDETAILTRNRQ OPTIONSPOTDETAILTRNRQ { get; set; }
    }
    /// <summary>
    /// 3.5.12期权现货交易明细查询请求主体
    /// </summary>
    public class OPTIONSPOTDETAILTRNRQ : BIZRQBASE
    {
        /// <summary>
        /// 3.5.12期权现货交易明细查询请求内容
        /// </summary>
        [XmlElement(Order = 1)]
        public OPTIONSPOTDETAILTRN_RQBODY RQBODY { get; set; }
    }
    /// <summary>
    /// 3.5.12期权现货交易明细查询请求内容
    /// </summary>
    public class OPTIONSPOTDETAILTRN_RQBODY
    {
        /// <summary>
