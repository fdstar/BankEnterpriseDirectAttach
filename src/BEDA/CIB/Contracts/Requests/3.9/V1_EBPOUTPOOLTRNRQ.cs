...
{
    /// <summary>
    /// 3.9.3.2电子商业汇票票据出池请求主体
    /// </summary>
    public class V1_EBPOUTPOOLTRNRQ : IRequest<V1_EBPOUTPOOLTRNRS>
    {
        /// <summary>
        /// 3.9.3.2电子商业汇票票据出池请求主体
        /// </summary>
        public EBPOUTPOOLTRNRQ EBPOUTPOOLTRNRQ { get; set; }
    }
    /// <summary>
    /// 3.9.3.2电子商业汇票票据出池请求主体
    /// </summary>
    public class EBPOUTPOOLTRNRQ : BIZRQBASE
    {
        /// <summary>
        /// 3.9.3.2电子商业汇票票据出池请求内容
        /// </summary>
        [XmlElement(Order = 2)]
        public EBPOUTPOOLTRN_RQBODY RQBODY { get; set; }
    }
    /// <summary>
    /// 3.9.3.2电子商业汇票票据出池请求内容
    /// </summary>
    public class EBPOUTPOOLTRN_RQBODY
    {
        /// <summary>
        /// 出池方式 ，01-托管出池 02-质押出池	必输
        /// </summary>
        [XmlElement(Order = 2)]
        ...
        /// <summary>
        /// 3.9.3.2电子商业汇票票据出池请求集合
        /// </summary>
        [XmlElement("CONTENT", Order = 30)]
        public List<EBPOUTPOOLTRN_CONTENT> List { get; set; }
    }
    /// <summary>
    /// 3.9.3.2电子商业汇票票据出池请求明细
    /// </summary>
    public class EBPOUTPOOLTRN_CONTENT
    {
        /// <summary>
        /// 小序号,4位	必输
        /// </summary>
