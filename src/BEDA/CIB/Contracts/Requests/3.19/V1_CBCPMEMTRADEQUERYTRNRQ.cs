...
{
    /// <summary>
    /// 3.19.10跨境资金池成员单位子账号交易明细查询请求主体
    /// </summary>
    public class V1_CBCPMEMTRADEQUERYTRNRQ : IRequest<V1_CBCPMEMTRADEQUERYTRNRS>
    {
        /// <summary>
        /// 3.19.10跨境资金池成员单位子账号交易明细查询请求主体
        /// </summary>
        public CBCPMEMTRADEQUERYTRNRQ CBCPMEMTRADEQUERYTRNRQ { get; set; }
    }
    /// <summary>
    /// 3.19.10跨境资金池成员单位子账号交易明细查询请求主体
    /// </summary>
    public class CBCPMEMTRADEQUERYTRNRQ : BIZRQBASE
    {
        /// <summary>
        /// 3.19.10跨境资金池成员单位子账号交易明细查询请求内容
        /// </summary>
        [XmlElement(Order = 2)]
        public CBCPMEMTRADEQUERYTRN_RQBODY RQBODY { get; set; }
    }
    /// <summary>
    /// 3.19.10跨境资金池成员单位子账号交易明细查询请求内容
    /// </summary>
    public class CBCPMEMTRADEQUERYTRN_RQBODY
    {
        /// <summary>
        /// 查询页数默认为1
        /// </summary>
