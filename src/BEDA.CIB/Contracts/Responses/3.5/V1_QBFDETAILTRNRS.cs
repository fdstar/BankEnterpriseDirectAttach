...
namespace BEDA.CIB.Contracts.Responses
{
    ...
    /// 3.5.9银期交易明细查询响应主体
    /// </summary>
    public class V1_QBFDETAILTRNRS : IResponse
    {
        /// <summary>
        /// 3.5.9银期交易明细查询响应主体
        /// </summary>
        public QBFDETAILTRNRS QBFDETAILTRNRS { get; set; }
    }
    /// <summary>
    /// 3.5.9银期交易明细查询响应主体
    /// </summary>
    public class QBFDETAILTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.5.9银期交易明细查询响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public QBFDETAILTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.5.9银期交易明细查询响应内容
    /// </summary>
    public class QBFDETAILTRN_RSBODY
    {
        /// <summary>
        /// MORE是否有下一页，Y有，N无
        /// </summary>
        ...
        public List<QBFDETAILTRN_CONTENT> List { get; set; }
    }
    /// <summary>
    /// 3.5.9银期交易明细查询响应明细
    /// </summary>
    public class QBFDETAILTRN_CONTENT
    {
        /// <summary>
        /// 账户代号，最长32位
        /// </summary>
