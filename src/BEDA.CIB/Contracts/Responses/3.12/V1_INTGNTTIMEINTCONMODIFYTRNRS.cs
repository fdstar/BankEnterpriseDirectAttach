...
{
    /// <summary>
    /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应主体
    /// </summary>
    public class V1_INTGNTTIMEINTCONMODIFYTRNRS : IResponse
    {
        /// <summary>
        /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应主体
        /// </summary>
        public INTGNTTIMEINTCONMODIFYTRNRS INTGNTTIMEINTCONMODIFYTRNRS { get; set; }
    }
    /// <summary>
    /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应主体
    /// </summary>
    public class INTGNTTIMEINTCONMODIFYTRNRS : BIZRSBASE
    {
        /// <summary>
        /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应内容
        /// </summary>
        [XmlElement(Order = 2)]
        public INTGNTTIMEINTCONMODIFYTRN_RSBODY RSBODY { get; set; }
    }
    /// <summary>
    /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应内容
    /// </summary>
    public class INTGNTTIMEINTCONMODIFYTRN_RSBODY
    {
        /// <summary>
        /// MORE是否有下一页，Y有，N无
        /// </summary>
        ...
        /// <summary>
        /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应集合
        /// </summary>
        [XmlElement("CONTENT", Order = 30)]
        public List<INTGNTTIMEINTCONMODIFYTRN_CONTENT> List { get; set; }
        /// <summary>
        /// 指令处理节点
        /// </summary>
        [XmlElement(Order = 40)]
    ...
    /// <summary>
    /// 3.12.7.3定活互转智能定期存款互联互通—修改/解约响应明细
    /// </summary>
    public class INTGNTTIMEINTCONMODIFYTRN_CONTENT
    {
        /// <summary>
        /// 关联智能定期存款账号	必回
        /// </summary>
