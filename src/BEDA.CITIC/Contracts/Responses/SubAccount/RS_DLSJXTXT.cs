...
namespace BEDA.CITIC.Contracts.Responses
{
    ...
    /// </summary>
    [XmlRoot("stream")]
    public class RS_DLSJXTXT : RsBase
    {
        /// <summary>
        /// 中信银行集合列表
        /// </summary>
        [XmlArray("list")]
        [XmlArrayItem("row")]
        public List<SubAccountInterest> List { get; set; }
    }
    /// <summary>
    /// 附属账户利息计算经办
    /// </summary>
    public class SubAccountInterest
    {
        /// <summary>
        /// 正常利率 decimal(9,7)
        /// </summary>
        ...
        /// 正常积数 decimal(15,2)
        /// </summary>
        [XmlElement("normAccum")]
        public decimal NormAccum { get; set; }
        /// <summary>
        /// 透支利率 decimal(9,7)
        /// </summary>
        [XmlElement("overRate")]
        ...
        /// 透支积数 decimal(15,2)
        /// </summary>
        [XmlElement("overAccum")]
        public decimal OverAccum { get; set; }
        /// <summary>
        /// 应付利息 decimal(15,2)
        /// </summary>
        [XmlElement("payAmt")]
