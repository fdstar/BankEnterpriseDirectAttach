...
namespace BEDA.CITIC.Contracts.Responses
{
    ...
    /// </summary>
    [XmlRoot("stream")]
    public class RS_DLBSNDQY : RsBase
    {
        /// <summary>
        /// 中信银行集合列表
        /// </summary>
        [XmlArray("list")]
        [XmlArrayItem("row")]
        public List<AgentBillDetailInfo> List { get; set; }
    }
    /// <summary>
    /// 业务明细
    /// </summary>
    public class AgentBillDetailInfo
    {
        /// <summary>
        /// 票据号varchar(16)
        /// </summary>
        ...
        /// <summary>
        /// 业务发生日期char(8)，格式YYYYMMDD
        /// </summary>
        [XmlIgnore]
        public DateTime BsnDate { get; set; }
        /// <summary>
        /// 业务发生日期char(8)，格式YYYYMMDD, 对应<see cref="BsnDate"/>
        /// </summary>
        [XmlElement("bsnDate")]
        public string BsnDateStr
        {
            get
            {
                return this.BsnDate.ToString("yyyyMMdd");
            }
            set
            {
                if (DateTime.TryParseExact(value, "yyyyMMdd", CultureInfo.CurrentCulture, DateTimeStyles.None, out DateTime tmp))
