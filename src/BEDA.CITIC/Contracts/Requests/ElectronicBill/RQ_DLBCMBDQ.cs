...
namespace BEDA.CITIC.Contracts.Requests
{
    ...
    /// </summary>
    [XmlRoot("stream")]
    public class RQ_DLBCMBDQ : RqBase<RS_DLBCMBDQ>
    {
        /// <summary>
        /// 业务对应请求代码
        /// </summary>
        [XmlElement("action")]
        public override string Action { get => "DLBCMBDQ"; set { } }
        /// <summary>
        /// 票据信息类型 char(4) 电子票据序列号为空时非空，类型见附录4.1.9
        /// </summary>
        [XmlElement("infoType")]
        ...
        /// <summary>
        /// 电子票据序列号 char(30) 可空，若电子票据序列号不为空，则按电子票据序列号查询，若电子票据序列号为空，则票据信息类型不可空
        /// </summary>
        [XmlElement("billNo")]
