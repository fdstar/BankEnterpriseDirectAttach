...
{
    /// <summary>
    /// 27.12.划拨关系限额设置经办请求主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ27_12 : CMBBase<RQINFO>, IRequest<RS27_12>
    {
        /// <summary>
        /// NTALMADD
        /// </summary>
        ...
        /// <summary>
        /// 27.12.划拨关系限额设置经办请求内容
        /// </summary>
        public NTBUSMODY NTBUSMODY { get; set; }
        /// <summary>
        /// 27.12.划拨关系限额设置经办请求内容
        /// </summary>
        public NTALMADDX1 NTALMADDX1 { get; set; }
    }
    /// <summary>
    /// 27.12.划拨关系限额设置经办请求内容
    /// </summary>
    public class NTALMADDX1
    {
        /// <summary>
        /// 分行号	C(2)
        /// </summary>
        ...
        /// <summary>
        /// 单笔最大限额	F(17,2) 限额设置位图第1位为Y时必输（大于0），为N时须为0
        /// </summary>
        public decimal? SGNMAX { get; set; }
        /// <summary>
        /// 日累计限额	F(17,2) 限额设置位图第2位为Y时不能为0
        /// </summary>
        ...
        /// <summary>
        /// 限额一周期累计天数	C(4)    限额设置位图第三位为Y并且限额一周期代码是S的时候不能为0
        /// </summary>
        ...
        /// <summary>
        /// 限额一周期限额	F(17,2) 限额设置位图CTLMAP第3位为Y时不能为0;限额设置位图CTLMAP第3位为N时必须为0
        /// </summary>
        ...
        /// <summary>
        /// 限额二周期累计天数	C(4)    限额设置位图CTLMAP第4位为Y并且PR2COD值为S时不能为0
        /// </summary>
        ...
        /// <summary>
        /// 限额二周期限额	F(17,2) 限额设置位图CTLMAP第4位为Y时不能为0 限额设置位图CTLMAP第4位为N时必须为0
        /// </summary>
