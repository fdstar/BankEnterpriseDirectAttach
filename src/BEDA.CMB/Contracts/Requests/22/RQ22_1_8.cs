...
{
    /// <summary>
    /// 22.1.8.纸质商业汇票托管取回请求主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ22_1_8 : CMBBase<RQINFO>, IRequest<RS22_1_8>
    {
        /// <summary>
        /// NTBILROD
        /// </summary>
        ...
        /// <summary>
        /// 22.1.8.纸质商业汇票托管取回请求内容
        /// </summary>
        public NTBILRODX1 NTBILRODX1 { get; set; }
        /// <summary>
        /// 22.1.8.纸质商业汇票托管取回请求集合
        /// </summary>
        [XmlElement("NTBILRODX2")]
        public List<NTBILRODX2> List { get; set; }
    }
    /// <summary>
    /// 22.1.8.纸质商业汇票托管取回请求内容
    /// </summary>
    public class NTBILRODX1
    {
        /// <summary>
        /// 分行号	C(2)
        /// </summary>
