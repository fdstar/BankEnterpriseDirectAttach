...
{
    /// <summary>
    /// 23.25.取关联结算户某日交易（续传）请求主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ23_25 : CMBBase<RQINFO>, IRequest<RS23_25>
    {
        /// <summary>
        /// NTCPATRX
        /// </summary>
        ...
        /// <summary>
        /// 23.25.取关联结算户某日交易（续传）请求内容
        /// </summary>
        public NTCPATRXX1 NTCPATRXX1 { get; set; }
    }
    /// <summary>
    /// 23.25.取关联结算户某日交易（续传）请求内容
    /// </summary>
    public class NTCPATRXX1
    {
        /// <summary>
        /// 分行号     	C(2)
        /// </summary>
