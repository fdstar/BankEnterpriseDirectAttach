...
{
    /// <summary>
    /// 19.2.11.提前兑付经办票据信息查询请求主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ19_2_11 : CMBBase<RQINFO>, IRequest<RS19_2_11>
    {
        /// <summary>
        /// SDKASHINQ
        /// </summary>
        ...
        /// <summary>
        /// 19.2.11.提前兑付经办票据信息查询请求内容
        /// </summary>
        public NTASHINQX NTASHINQX { get; set; }
    }
    /// <summary>
    /// 19.2.11.提前兑付经办票据信息查询请求内容
    /// </summary>
    public class NTASHINQX
    {
        /// <summary>
        /// 客户编号	C(10)
        /// </summary>
