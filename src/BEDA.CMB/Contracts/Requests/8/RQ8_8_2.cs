...
{
    /// <summary>
    /// 8.8.2.银证转账直联综合查询请求主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ8_8_2 : CMBBase<RQINFO>, IRequest<RS8_8_2>
    {
        /// <summary>
        /// NTSECDQY
        /// </summary>
        /// <returns></returns>
        public override string GetFUNNAM() => "NTSECDQY";
        /// <summary>
        /// 8.8.2.银证转账直联综合查询请求内容
        /// </summary>
