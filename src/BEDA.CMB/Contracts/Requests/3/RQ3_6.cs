...
namespace BEDA.CMB.Contracts.Requests
{
    ...
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RQ3_6 : CMBBase<RQINFO>, IRequest<RS3_6>
    {
        /// <summary>
        /// DCPAYMNT
        /// </summary>
        ...
        /// <summary>
        /// 3.6.直接支付请求主体 支付概要
        /// 注意此处只支持 N02031:直接支付 N02041:直接集团支付
        /// </summary>
        ...
        /// </summary>
        [XmlElement("DCOPDPAYX")]
        public List<DCOPDPAYX> List { get; set; }
    }
    /// <summary>
    /// 3.1.支付请求内容 支付明细
    /// </summary>
    public class DCOPDPAYX
    {
        ...
        /// <summary>
        /// 城市代码	C(4)	附录A.18 
        /// CRTFLG不为Y时行内支付必填 为空则不支持收方识别功能
        /// </summary>
        public string CTYCOD { get; set; }
        /// <summary>
        /// 收方行地址	Z(62)	跨行支付（BNKFLG=N）必填；CRTFLG不为Y时行内支付必填。
        /// 例如：广东省深圳市南山区
        /// </summary>
        public string CRTADR { get; set; }
        /// <summary>
        /// 收方信息不检查标志	C(1)	Y: 行内支付不检查城市代码和收方行地址 默认为Y。
        /// </summary>
