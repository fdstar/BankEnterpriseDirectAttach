...
{
    /// <summary>
    /// 28.1.6.查询大额划拨业务详细信息响应主体
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RS28_1_6 : CMBBase<RSINFO>, IResponse
    {
        /// <summary>
        /// NTGMTIND
        /// </summary>
        ...
        /// <summary>
        /// 28.1.6.查询大额划拨业务详细信息响应内容
        /// </summary>
        public NTGMTINDZ1 NTGMTINDZ1 { get; set; }
    }
    /// <summary>
    /// 28.1.6.查询大额划拨业务详细信息响应内容
    /// </summary>
    public class NTGMTINDZ1
    {
        /// <summary>
        /// 流程实例号   	C(10)
        /// </summary>
