...
namespace BEDA.CMB.Contracts.Responses
{
    ...
    /// </summary>
    [XmlRoot("CMBSDKPGK")]
    public class RS8_3_7 : CMBBase<RSINFO>, IResponse
    {
        /// <summary>
        /// NTCURQRY
        /// </summary>
        ...
        /// 8.3.7.当前委托查询响应集合
        /// </summary>
        [XmlElement("NTCURQRYZ")]
        public List<NTCURQRYZ> List { get; set; }
    }
    /// <summary>
    /// 8.3.7.当前委托查询响应内容
    /// </summary>
    public class NTCURQRYZ
    {
        /// <summary>
        /// 产品代码	C(8)
        /// </summary>
